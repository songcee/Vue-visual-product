<!-- 页面分为上中下三个模块，上方、下方模块高度固定，中间模块高度自适应 -->
<template>
  <div class="module6-container">
    <div class="module6-top" :style="{height: formate.input1 + 'px'}" @click="chooseModule(0)">
      <!-- 选中的遮罩效果 -->
