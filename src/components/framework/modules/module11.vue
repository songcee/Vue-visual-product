...
<template>
  <div class="module11-container">
    <div class="module11-left" :style="{width: formate.input1 + '%'}" @click="chooseModule(0)">
      <!-- 选中的遮罩效果 -->
    ...
    <div
      class="module11-right"
      :style="{left: formate.input1 + '%'}"
