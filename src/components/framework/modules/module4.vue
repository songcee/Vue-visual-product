<!-- 页面分为三个模块，上部模块高度固定固定， 下部模块高度铺满剩下部分，左侧宽度固定，右侧宽度铺满剩下部分。 -->
<template>
  <div class="module4-container">
    <div class="module4-top" :style="{height: formate.input1 + 'px'}" @click="chooseModule(0)">
      <!-- 选中的遮罩效果 -->
    ...
    <div class="module4-bottom" :style="{top: (Number(formate.input1) + 1) + 'px'}">
      <div
        class="module4-bottom-left"
      ...
      <div
        class="module4-bottom-right"
        :style="{left: Number(formate.input2) + 1 + 'px'}"
